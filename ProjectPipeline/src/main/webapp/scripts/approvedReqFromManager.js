function grabRequestsFromJson(){
    ...
    xhr.onreadystatechange = function(){
        if(xhr.readyState === 4 & xhr.status === 200){
            ...
            for(let req of requests){
				...
				applicantForm.setAttribute("action", "/ProjectPipeline/app/manager/employeeInfo");			
				...
				form.setAttribute("action", "/ProjectPipeline/app/manager/ReimbRequestDetail");			
	...
	var url = "/ProjectPipeline/app/manager/approvedReq"
